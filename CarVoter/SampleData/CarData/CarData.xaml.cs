...
// the DISABLE_SAMPLE_DATA conditional compilation constant and disable sample data at runtime.
	...
	public class CarData : INotifyPropertyChanged
	{
		...
		public CarData()
		{
			try
			{
				Uri resourceUri = new Uri("/CarVoter;component/SampleData/CarData/CarData.xaml", UriKind.RelativeOrAbsolute);
	...
	public class Item : INotifyPropertyChanged
	{
		...
		private double _KiloWats = 0;

		public double KiloWats
		{
			get
			{
				return this._KiloWats;
			}

			set
			{
				if (this._KiloWats != value)
				{
					this._KiloWats = value;
					this.OnPropertyChanged("KiloWats");
				}
			}
		}
